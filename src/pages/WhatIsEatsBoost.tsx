...
const WhatIsEatsBoost = () => {
  return (
    <div className="min-h-[100dvh] flex flex-col items-center p-6 bg-black text-white">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="space-y-8 text-center max-w-4xl mx-auto">
          ...
          <p 
            className="text-xl md:text-2xl text-gray-400 leading-relaxed animate-fade-up opacity-0"
