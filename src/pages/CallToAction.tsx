    ...
    <div className="min-h-[100dvh] flex flex-col items-center p-6">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="mt-12 space-y-8 text-center">
          <h1 className="text-6xl font-bold bg-gradient-to-r from-black to-gray-700 bg-clip-text text-transparent animate-fade-up opacity-0" style={{ animationDelay: "0.2s" }}>
            Got Offers
          </h1>
